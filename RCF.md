...
Checkout cujo `origin` corresponda exatamente ao upstream configurado PODE adotar, na ausência de lock, arquivo normativo rastreado como previamente gerenciado; remoto divergente, fork e consumidor comum NÃO recebem essa presunção e continuam sujeitos ao bloqueio de colisão.
