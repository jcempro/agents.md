...
Modelo de autor DEVE declarar identidade/resumo obrigatórios, campos opcionais, invalidez, fallback visual, destaque e compactação; nomes de campo e limiar visual pertencem ao adaptador/template. Semântica representa pessoa/autoria quando aplicável; legado NÃO DEVE exigir migração.
...
Exceto reflexão, testemunho, opinião, literatura ou poesia identificados, artigo DEVE buscar verificabilidade; fato, história, estatística, estudo, técnica, citação, tradução e controvérsia DEVERIAM ter fonte válida, confiável, rastreável e proporcional à alegação. Artigo técnico/sermão sujeito a fonte DEVE usar `Afirmação → referência imediata`, sem fonte distante ou incapaz de sustentar a frase. Nota DEVE ter mecanismo compatível, id estável, ida/retorno, teclado/mobile e baixa interferência. Referência/Bibliografia DEVERIA derivar de nota/metadado; padrão decorre da política/jurisdição/RCF; biblioteca exige compatibilidade, manutenção, acessibilidade e degradação que preserve conteúdo.
