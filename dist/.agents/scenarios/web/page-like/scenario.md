...
| `WEB-EDITORIAL` | RCF classifica artefato publicável como artigo, post, sermão, ensaio, notícia ou editorial equivalente | `capabilities/editorial.md` | `WEB-BROWSER`; `WEB-STATIC` somente se seu predicado for verdadeiro |
