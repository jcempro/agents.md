...
1. `validated-session-cache`: economia ponderada de 47.530 tokens (55,80%), equivalência integral nos seis cenários, risco experimental 0,30 e nenhuma regressão local medida.
...
- reexecutar o experimento FT-097 com os mesmos seis cenários, 688 átomos e 16 relações;
