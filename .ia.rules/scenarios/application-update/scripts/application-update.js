...
function defaultHttpClient(url) {
  return new Promise((resolve, reject) => {
    const request = https.request(url, { headers: { Accept: "application/json", "User-Agent": "agents-application-update" }, timeout: 3e4 }, (response) => {
      const chunks = [];
